export const en = {
  ...
  projects: {
    ...
    customFieldsEmpty: 'No custom field values yet.',
    customFieldsRequired: 'Fill the required custom fields before submitting.',
    import: {
      title: 'Import projects',
      description:
        'Upload a CSV (Excel-compatible) to create draft proposals in your factory. Existing codes are skipped.',
      dropHint: 'Drop a CSV file here or click to browse',
      dropActive: 'Drop to upload',
      downloadTemplate: 'Download CSV template',
      emptyFile: 'The spreadsheet has no data rows.',
      parseFailed: 'Unable to read this spreadsheet.',
      tooManyRows: 'Import is limited to {{count}} rows.',
      mapHint: 'Match spreadsheet columns for {{file}}.',
      skipColumn: 'Do not import',
      preview: 'Preview',
      previewSummary: '{{valid}} ready to import · {{invalid}} with errors',
      rowLabel: 'Row {{row}}',
      importRows: 'Import {{count}} drafts',
      importing: 'Importing…',
      success:
        'Imported {{created}} drafts. Skipped {{skipped}} existing codes. {{failed}} rows had errors.',
      failed: 'Unable to import projects',
      unknownPm: 'Unknown project manager email: {{email}}',
      duplicateCode: 'Duplicate code in file: {{code}}',
      fields: {
        code: 'Code',
        title: 'Title',
        description: 'Description',
        ...
        assigned_pm_email: 'Project manager email',
      },
    },
  ...
  deadlines: {
    title: 'Deadlines',
    description:
      'Task due dates, phase end dates, and project end dates across your scope. This is not the project Gantt.',
    loadFailed: 'Failed to load deadlines',
  ...
  settings: {
    ...
    customFields: {
      ...
      description:
        'Define extra fields shown on project forms. Factory managers fill them when creating proposals.',
      add: 'Add field',
      addTitle: 'New custom field',
      editTitle: 'Edit custom field',
      key: 'Field key',
      keyHelp: 'Lowercase letters, numbers, and underscores. Used as the CSV column name.',
      labelEn: 'Label (English)',
      labelAr: 'Label (Arabic)',
      fieldType: 'Field type',
      options: 'Options',
      optionsHelp: 'One option per line (or comma-separated).',
      created: 'Custom field added',
      updated: 'Custom field updated',
      deleted: 'Custom field deleted',
      empty: 'No custom fields yet. Add one to get started.',
  ...
  validation: {
    ...
    selectInvalid: 'Choose one of the allowed options',
    fieldKeyFormat:
      'Key must start with a letter and use only lowercase letters, numbers, or _',
    selectOptionsRequired: 'Select fields need at least one option',
  },
  a11y: {
