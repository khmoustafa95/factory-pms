export const en = {
  ...
  dashboard: {
    ...
    underfundedProjects: 'Underfunded projects',
    overdueProcurement: 'Overdue procurement items',
    filterUnderfunded: 'Underfunded',
    filterUnderfundedOnly: 'Funding gap',
    filterOverdueProcurement: 'Procurement overdue',
    filterOverdueProcurementOnly: 'Has overdue procurement',
  },
  projects: {
    title: 'Projects',
    managerDescription:
  ...
  projectFinance: {
    ...
    snapshot: {
      ...
      description:
        'Approved budget, funding received, expense plan, and spend at a glance.',
      approvedBudget: 'Approved budget',
      fundingPlanned: 'Funding planned',
      fundingReceived: 'Funding received',
      fundingGap: 'Funding gap',
      expensePlanTotal: 'Expense plan (total)',
      expensePlanWbs: 'WBS plan (from phases)',
      expensePlanOverhead: 'Overhead plan',
      spentTotal: 'Spent (total)',
      budgetRemaining: 'Budget remaining',
    },
    funding: {
      title: 'Incoming funding',
      description: 'Track funding sources, amounts, and receipt dates.',
      formDescription: 'Record a planned or received funding entry.',
      addTitle: 'Add funding entry',
      editTitle: 'Edit funding entry',
      sourceType: 'Source type',
      sourceName: 'Source name',
      amount: 'Amount',
      expectedDate: 'Expected date',
      receivedDate: 'Received date',
      empty: 'No funding entries yet.',
      added: 'Funding entry added',
      updated: 'Funding entry updated',
      deleted: 'Funding entry deleted',
      saveFailed: 'Unable to save funding entry',
      deleteFailed: 'Unable to delete funding entry',
      sourceTypes: {
        internal: 'Internal',
        loan: 'Loan',
        grant: 'Grant',
    ...
    procurement: {
      ...
      description: 'Plan purchases and track delivery status.',
      formDescription: 'Add or update a procurement line item.',
      addTitle: 'Add procurement item',
      editTitle: 'Edit procurement item',
      quantity: 'Quantity',
      unit: 'Unit',
      estimatedCost: 'Estimated cost',
      neededBy: 'Needed by',
      supplier: 'Supplier',
      openCount: '{{count}} open items',
      empty: 'No procurement items yet.',
      added: 'Procurement item added',
      updated: 'Procurement item updated',
      deleted: 'Procurement item deleted',
      saveFailed: 'Unable to save procurement item',
      deleteFailed: 'Unable to delete procurement item',
      statuses: {
        planned: 'Planned',
        ordered: 'Ordered',
        delivered: 'Delivered',
    ...
    staff: {
      ...
      endDate: 'End date',
      totalHeadcount: '{{count}} planned headcount',
      empty: 'No staff records yet.',
      added: 'Staff record added',
      updated: 'Staff record updated',
      deleted: 'Staff record deleted',
      saveFailed: 'Unable to save staff record',
      deleteFailed: 'Unable to delete staff record',
    },
    expensePlan: {
      title: 'Expense plan (overhead)',
      description:
        'Non-WBS overhead lines. WBS execution costs roll up from phases and tasks.',
      formDescription: 'Add an overhead expense line not covered by WBS tasks.',
      addTitle: 'Add expense line',
      editTitle: 'Edit expense line',
      category: 'Category',
      plannedAmount: 'Planned amount',
      actualAmount: 'Actual amount',
      wbsRollup: 'WBS planned total from phases: {{amount}}',
      empty: 'No overhead expense lines yet.',
      added: 'Expense line added',
      updated: 'Expense line updated',
      deleted: 'Expense line deleted',
      saveFailed: 'Unable to save expense line',
      deleteFailed: 'Unable to delete expense line',
      categories: {
        materials: 'Materials',
        labor: 'Labor',
        equipment: 'Equipment',
  ...
  validation: {
    ...
    fundingSourceNameRequired: 'Source name is required for "Other" sources',
