export const ar = {
  ...
  projects: {
    ...
    customFieldsEmpty: 'لا توجد قيم لحقول مخصصة بعد.',
    customFieldsRequired: 'أكمل الحقول المخصصة المطلوبة قبل الإرسال.',
    import: {
      title: 'استيراد المشاريع',
      description:
        'ارفع ملف CSV متوافقاً مع Excel لإنشاء مسودات مقترحات في مصنعك. الرموز الموجودة تُتخطى.',
      dropHint: 'أسقط ملف CSV هنا أو انقر للتصفح',
      dropActive: 'أفلت للرفع',
      downloadTemplate: 'تنزيل قالب CSV',
      emptyFile: 'لا يحتوي الجدول على صفوف بيانات.',
      parseFailed: 'تعذر قراءة هذا الجدول.',
      tooManyRows: 'الاستيراد محدود بـ {{count}} صف.',
      mapHint: 'طابق أعمدة الجدول لملف {{file}}.',
      skipColumn: 'عدم الاستيراد',
      preview: 'معاينة',
      previewSummary: '{{valid}} جاهز للاستيراد · {{invalid}} فيه أخطاء',
      rowLabel: 'الصف {{row}}',
      importRows: 'استيراد {{count}} مسودة',
      importing: 'جاري الاستيراد…',
      success:
        'تم استيراد {{created}} مسودة. تُخطّي {{skipped}} رمزاً موجوداً. {{failed}} صفوف فيها أخطاء.',
      failed: 'تعذر استيراد المشاريع',
      unknownPm: 'بريد مدير مشروع غير معروف: {{email}}',
      duplicateCode: 'رمز مكرر في الملف: {{code}}',
      fields: {
        code: 'الرمز',
        title: 'العنوان',
        description: 'الوصف',
        budget: 'الميزانية',
        currency: 'العملة',
        proposed_start_date: 'تاريخ البدء المقترح',
        proposed_end_date: 'تاريخ الانتهاء المقترح',
        assigned_pm_email: 'بريد مدير المشروع',
      },
    },
    proposedBy: 'مقدّم من',
    pm: 'مدير المشروع',
  ...
  deadlines: {
    ...
    description:
      'تواريخ استحقاق المهام ونهاية المراحل والمشاريع ضمن نطاقك. هذه ليست مخطط غانت.',
    loadFailed: 'فشل تحميل المواعيد النهائية',
    empty: 'لا توجد مواعيد في هذا التاريخ.',
    forDate: '{{date}}',
  ...
  settings: {
    ...
    customFields: {
      title: 'حقول المشروع المخصصة',
      description:
        'عرّف حقولاً إضافية تظهر في نماذج المشروع. يملأها مديرو المصانع عند إنشاء المقترحات.',
      add: 'إضافة حقل',
      addTitle: 'حقل مخصص جديد',
      editTitle: 'تعديل الحقل المخصص',
      key: 'مفتاح الحقل',
      keyHelp: 'أحرف صغيرة وأرقام وشرطات سفلية. يُستخدم كاسم عمود CSV.',
      labelEn: 'التسمية (إنجليزي)',
      labelAr: 'التسمية (عربي)',
      fieldType: 'نوع الحقل',
      options: 'الخيارات',
      optionsHelp: 'خيار واحد في كل سطر (أو مفصولة بفواصل).',
      created: 'تمت إضافة الحقل المخصص',
      updated: 'تم تحديث الحقل المخصص',
      deleted: 'تم حذف الحقل المخصص',
      empty: 'لا توجد حقول مخصصة. أضف حقلاً للبدء.',
      loadFailed: 'فشل تحميل الحقول المخصصة',
    },
  },
  errors: {
    generic: 'حدث خطأ ما',
  ...
  validation: {
    ...
    numberInvalid: 'أدخل رقماً صالحاً',
    dateInvalid: 'أدخل تاريخاً صالحاً',
    selectInvalid: 'اختر أحد الخيارات المتاحة',
    fieldKeyFormat:
      'يجب أن يبدأ المفتاح بحرف ويستخدم أحرفاً صغيرة أو أرقاماً أو _ فقط',
    selectOptionsRequired: 'حقول الاختيار تحتاج خياراً واحداً على الأقل',
  },
  a11y: {
