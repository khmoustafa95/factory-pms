export const ar = {
  ...
  dashboard: {
    ...
    projectsManagerDescription: 'تقديم مقترحات المشاريع لمراجعة مدير المشروع.',
    projectsDirectorDescription:
      'متابعة مقترحات المصانع والمشاريع المعتمدة على مستوى الشركة.',
    projectsPmDescription:
      'مراجعة المقترحات المعينة، مناقشة التفاصيل، ثم الموافقة أو الرفض.',
  ...
  projects: {
    title: 'المشاريع',
    managerDescription:
      'إنشاء مقترحات المشاريع مع الملفات الداعمة وتعيين مدير مشروع للمراجعة.',
    directorDescription: 'متابعة المقترحات وتقدم المشاريع عبر جميع المصانع.',
    pmDescription:
      'مراجعة المقترحات المعينة، مناقشة التفاصيل مع مدير المصنع، ثم الموافقة أو الرفض.',
    ...
    proposalSubmitted: 'تم إرسال المقترح لمراجعة مدير المشروع',
    ...
    formDescription:
      'تحديد النطاق والميزانية والجدول الزمني والملفات الداعمة لمراجعة مدير المشروع.',
    ...
    proposalDiscussionDescription:
      'ناقش الميزانية والعمالة والجدول الزمني وتفاصيل أخرى قبل الاعتماد.',
    proposalSummary: 'ملخص المقترح',
    awaitingPmReview: 'بانتظار مراجعة مدير المشروع',
    attachments: {
