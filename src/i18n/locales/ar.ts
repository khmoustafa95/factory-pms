export const ar = {
  ...
  projects: {
    ...
    startDialog: {
      title: 'بدء التنفيذ',
      description:
        'أكد جاهزية المراحل ومدير المشروع المعيّن. غياب المهام ونقص التمويل تحذيران وليسا مانعين.',
      fundingReceived: 'التمويل المستلم',
      fundingWarning:
        'التمويل المستلم أقل من الميزانية المعتمدة. يمكنك مع ذلك بدء التنفيذ.',
      noTasksWarning:
        'لم يعدّ مدير المشروع المهام بعد. يمكنك مع ذلك بدء التنفيذ.',
    },
    planning: {
      title: 'تسليم التخطيط',
      description:
  ...
  wbs: {
    ...
    fmManageDescription:
      'صمّم المراحل بأوزان تصل إلى 100% وميزانيات تطابق المشروع. يتحدّث المخطط الزمني أعلاه مع تواريخ المراحل. يعدّ مدير المشروع المهام تحت كل مرحلة.',
    pmManageDescription:
    ...
    noTasksFmPlanning: 'بانتظار مدير المشروع لإعداد مهام هذه المرحلة.',
    kanbanPlanningHint:
