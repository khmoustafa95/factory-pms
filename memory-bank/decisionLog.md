...
- 2026-07-22 — Vite `--mode` for env stages (`development` = local Supabase, `staging`, `production`) — committed placeholder env files; secrets in `*.local` (gitignored). Local defaults use standard `supabase start` URL/key.
